...
public class Main {
    public static void main(String[] args) {
        ...
        List<String> animals = List.of(camel, lion, deer, goose, bat, rabbit);
...
class Zookeeper{
    ...
    public static void setAnimals(List<String> animals) {
        Zookeeper.animals = animals;
    }

    public static void printAnimals(int index){
